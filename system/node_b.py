...
class NodeB:
    ...
    '''
    def __init__(self, m, sc_adjustment = False, mcs_automatic = False, sort_criterium = 't_connection', tx_all_buffer = False):
    ...
    def step_data(self, action):
        ...
        if not new_data:
            ...
            tbs = find_next_integer(TBS_list, ue.buffer) # assume all the buffer is sent
