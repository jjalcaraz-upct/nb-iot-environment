...
FLAG_FILE = '/shared/projects/nbiot/code/flag.txt'
PARTIAL_RESULTS = '/shared/projects/nbiot/results/partial.txt'
FINAL_RESULTS_PATH = '/home/jjalcaraz/projects/NBIoT_environment_v5/results/'
...
class Evaluator():
    ...
    def evaluate(self, i):
        ...
        if self.algorithm == 'DQN':
            ...
            discrete = False 
        nbiot_env = NPRACH_wrapper_traces(nbiot_env, metrics, discrete = discrete, norm = 100, logfile = self.logfile, verbose = VERBOSE, experiment = i, n_report = UPDATE)
