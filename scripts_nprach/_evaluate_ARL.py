...
class Evaluator():
    ...
    def evaluate(self, i):
        ...
        agent = NPRACH_THAgent(agent_3, metrics, verbose = False, no_th = NO_TH)
        ...
        if self.algorithm in ['TD3', 'DDPG']:
            ...
            # model = algo('MlpPolicy', env, verbose=0, policy_kwargs = policy_kwargs, seed = rl_seed, device = 'cpu')
            ent_coef = 0.01
